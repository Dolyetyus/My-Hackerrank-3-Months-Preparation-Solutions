...
int equalStacks(vector<int> h1, vector<int> h2, vector<int> h3) {
    ...
    long h1total = accumulate(h1.begin(), h1.end(), 0);
    long h2total = accumulate(h2.begin(), h2.end(), 0);
    long h3total = accumulate(h3.begin(), h3.end(), 0);

    while (!(h1total == h2total && h2total == h3total)) {
        ...
        else if (h3total >= h1total && h3total >= h2total) {
            h3total -= h3.at(0);
            h3.erase(h3.begin());
        }
    }
